  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto space-y-4">
        <div>
          <label htmlFor="engine" className="block text-sm font-medium text-purple-gray mb-2">Template Engine</label>
          <select
            id="engine"
            value={engine}
        ...
        <div>
          <label htmlFor="goal" className="block text-sm font-medium text-purple-gray mb-2">Goal / Command</label>
          <textarea
            id="goal"
            value={goal}
