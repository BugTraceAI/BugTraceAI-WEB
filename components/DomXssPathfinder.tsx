                    ...
                    <div className="space-y-4">
                        {result.connected_paths.map((path, index) => (
                            <div key={index} className="bg-green-900/30 p-4 rounded-lg border border-green-500/30">
                                ...
                                <div className="mt-3">
                                    <p className="text-xs text-muted mb-1">Connecting Code:</p>
                                 ...
                                 <div className="mt-3">
                                    ...
                                    <p className="text-sm text-purple-gray">{path.explanation}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ) : (
                    <p className="text-purple-gray text-sm italic">No high-confidence vulnerable paths were found.</p>
                )}
            </div>
            ...
            <div>
                <h4 className="text-lg font-bold text-yellow-400 mb-3">Unconnected Findings (Informational)</h4>
                 {result.unconnected_findings?.length > 0 ? (
                    ...
                    <p className="text-purple-gray text-sm italic">No additional unconnected sources or sinks were identified.</p>
                 )}
            </div>
        </div>
      )}
