...
const T: Record<string, [LogLevel, string]> = {
  ...
  'recon.auth.started':          ['INFO',    '[RECON] Auth discovery scanning {urls_count} URLs on {target_url}'],
  ...
  'recon.auth.completed':        ['INFO',    '[RECON] Auth discovery completed — {jwts_found} JWTs, {cookies_found} cookies'],
